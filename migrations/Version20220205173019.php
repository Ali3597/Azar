 ...
 */
final class Version20220205173019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE design ADD views INT NOT NULL');
        $this->addSql('ALTER TABLE produit ADD views INT NOT NULL');
    }
